...
######################################################################################################
offset_bounding_box = 90     # 글자 바운딩 박스 허용범위 오프셋
...
tolerance_custom_name.top_left = rect.Point(1055 - offset_bounding_box, 510 - offset_bounding_box)
tolerance_custom_name.bottom_right = rect.Point(1558 + offset_bounding_box, 621 + offset_bounding_box)
